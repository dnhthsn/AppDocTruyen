...
public class DatabaseDoctruyen extends SQLiteOpenHelper {
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'son1','son1','son1@gmail.com',3)";
    //private String SQLQuery3 = "DELETE FROM TaiKhoan WHERE TEN_TAI_KHOAN = 'thanh'";
    ...
    public Cursor getData1(){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM " + TABLE_TRUYEN + " ORDER BY " + ID_TRUYEN + " DESC LIMIT 3" ,
                null);
        return res;
    }
